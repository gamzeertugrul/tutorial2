...
const app = express(); 
const pool=new pg({host:'ec2-54-247-78-30.eu-west-1.compute.amazonaws.com',database:'d4aanhf0n120m0',user:'jhzdygqqkrfgyt',password:'03e266ab35b94cd40c7f3d425f82e12630e0b3897d02b7d6e1d21c9631e3342e',port:'5432',ssl: { rejectUnauthorized:false}});
app.use(bodyParser.urlencoded({extended: true})); 
app.use(bodyParser.json());  
const _port = process.env.PORT || 5000; const _app_folder = __dirname + '/dist' ; 
